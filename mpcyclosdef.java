...
public void user_should_click_on_Order_By_dropdown() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
...
public void user_should_click_on_the_keywords() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
	mpcyclosrepo.keywords.click();
}

@Given("User should click on the show advertisements")
public void user_should_click_on_the_show_advertisements() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
	mpcyclosrepo.showad.click();
}

@Given("User should click on the community")
public void user_should_click_on_the_community() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
...
public void user_should_click_on_the_activites() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
...
public void user_should_click_on_any_categories_in_activity() {
	PageFactory.initElements(driver, mpcyclosrepo.class);
